...
class PublishCommentUseCase @Inject constructor(val socialRepository: SocialRepository): UseCase<CommentWrapperModel, PublishCommentUseCase.PublishCommentParams>() {
